...
from mainwindow_layouts_3 import Ui_MainWindow
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.original_pixmap = None # Addded this
    ...
    def update_image(self): # Added this
    ...
    def resizeEvent(self, event): # Added this
